...
export const SignUpForm = () => {
  ...
  return (
    <motion.main
      ...
      className="w-full min-h-screen flex overflow-y-hidden pb-24 pt-10"
    >
      {/* Left Side - Desktop View */}
      <motion.div
        variants={itemVariants}
        className="relative flex-1 hidden items-center justify-center min-h-screen bg-transparent lg:flex"
      >
      ...
      <motion.div
        variants={itemVariants}
        className="flex-1 relative flex items-center justify-center min-h-full"
      >
        <motion.img
          initial={{ opacity: 0, y: -100 }}
